      ...
      <form ref={formRef} action={dispatch} className="mt-4 space-y-4">
        ...
        <div>
          <button
            type="submit"
            disabled={isPending}
            className="group relative flex w-full justify-center rounded-md px-3 py-3 text-sm font-semibold text-white disabled:opacity-50 disabled:cursor-not-allowed bg-(--primary-color) hover:brightness-110 transition-all"
          >
